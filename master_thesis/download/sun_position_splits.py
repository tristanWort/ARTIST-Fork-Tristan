...
"""Script copied from PAINT: plots/02_create_dataset_splits.py"""
...
if __name__ == "__main__":
    ...
    config_file = Path("/jump/tw/master_thesis/ARTIST-Fork-Tristan/master_thesis/download/config.json")
    ...
    output_dir = config.get("output_dir", "PATH/TO/OUTPUT/PLOTS")
