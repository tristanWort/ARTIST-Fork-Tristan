...
def add_error_terms(parameters: torch.nn.ParameterList, error_config: dict(), seed=42, device: Union[torch.device, str] = "cuda:0"):
    """
...
def add_random_errors_to_kinematic(error_config: dict, scenario, 
                                   save_dir: str, seed=42, 
                                   device="cuda:0") -> RigidBody:
    """
