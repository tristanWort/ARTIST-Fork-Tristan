...
def objective(params):
    ...
    mse = run_experiment(run_config, n_epochs, n_samples, h_idx, threshold, sharpness, sigma_in, sigma_out, num_interpolations, beta, tolerance)
...
if __name__ == '__main__':
    ...
    search_space = [
        ...
        Integer(30, 80, name="sharpness"),  # instead use some sharpness scaling factor (increase over scaling epochs)
        Real(50.0, 60.0, name="sigma_in"),
        Real(25.0, 50.0, name="sigma_out"),
        Integer(1, 4, name="num_interpolations"),
        Real(0.3, 0.7, name="beta"),
        ]
    ...
    res = gp_minimize(
        ...
        n_calls=30,         # You can increase this
        random_state=7,
        verbose=True,
        )
    ...
    json.dump(best_params, open(f'/dss/dsshome1/05/di38kid/master_thesis/ARTIST-Fork-Tristan/master_thesis/HeliOptiCal/image_losses/{h_idx}_best_parameters.json', 'w+'), indent=4)
